...
export function Tracking() {
  ...
  return (
    <div className="grid gap-6 xl:grid-cols-[1fr_21rem]">
      ...
      >
        <ul className="max-h-[32rem] divide-y divide-soil-600/50 overflow-y-auto">
          {moving.map((shipment) => (
            <li
              key={shipment.shipment_id}
              className={`cursor-pointer px-5 py-4 transition-colors hover:bg-soil-700/40 ${
                selected === shipment.shipment_id ? "bg-soil-700/50" : ""
              }`}
