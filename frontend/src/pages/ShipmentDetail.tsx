  ...
  return (
    <div className="space-y-6">
          ...
          {shipment.status === "PENDING" && (
            <>
              <select
                ...
                className="rounded-lg border border-soil-600 bg-soil-800 px-2.5 py-2 text-[11px] text-husk outline-none focus:border-crop/60"
              >
      ...
      <Panel bodyClassName="p-5">
        ...
        {risk.data && (
          <p className="mt-5 flex items-start gap-2 rounded-lg border border-soil-600 bg-soil-700/40 px-3 py-2 text-[11px] text-moss">
