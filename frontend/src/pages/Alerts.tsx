    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <select
          ...
          className="rounded-lg border border-soil-600 bg-soil-800 px-2.5 py-1.5 text-[11px] text-husk outline-none focus:border-crop/60"
        >
              ...
              >
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {alert.audience && (
                      <span className="rounded-full border border-soil-600 px-2 py-0.5 text-[10px] text-moss">
