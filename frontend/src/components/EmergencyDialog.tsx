...
const fieldClass =
  "w-full rounded-lg border border-soil-600 bg-soil-900 px-3 py-2 text-xs text-husk outline-none focus:border-crop/60";
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            className="w-full max-w-md rounded-2xl border border-rot/40 bg-soil-800 shadow-panel"
          >
            <header className="flex items-center gap-2 border-b border-soil-600/70 px-5 py-4">
            ...
            <div className="space-y-4 px-5 py-5">
              ...
              {selected?.shipment_id && (
                <p className="rounded-lg border border-soil-600 bg-soil-700/40 px-3 py-2 text-[11px] text-moss">
